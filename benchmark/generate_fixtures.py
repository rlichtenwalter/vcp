...
# Large-tier fixtures are generated by the C++ tool `vcp_gen_er_fixture`
# in tools/; see benchmark/README.md. This Python script only emits
# the small test-tier fixtures where set-based clarity beats scaling.
